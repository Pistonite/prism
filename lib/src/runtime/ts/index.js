...
class Prism {
    ...
    union(shape) {
        return new ShapeHandle(__builtin_shape_union(this._into_shape(), shape));
    }
    intersection(shape) {
        return new ShapeHandle(__builtin_shape_intersection(this._into_shape(), shape));
    }
    difference(shape) {
        return new ShapeHandle(__builtin_shape_difference(this._into_shape(), shape));
    }
