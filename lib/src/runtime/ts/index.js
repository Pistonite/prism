...
class Prism {
    ...
    union(shape) {
        return __builtin_shape_union(this._into_shape(), shape);
    }
    intersection(shape) {
        return __builtin_shape_intersection(this._into_shape(), shape);
    }
    difference(shape) {
        return __builtin_shape_difference(this._into_shape(), shape);
    }


    _into_shape() {
        return __builtin_shape_from_prism(
